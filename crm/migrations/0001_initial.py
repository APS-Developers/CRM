    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DateClosed', models.DateField(blank=True, null=True, verbose_name='Date Closed (mm/dd/yyyy)')),
                ('AlternateHW', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='inventory.inventory')),
